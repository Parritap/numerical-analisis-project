...
try
    ...
    if f(a) * f(b) > 0
        ...
        while errorActual > errorEsperado
            ...
            if cont == 1
                errorActual = inf; % Infinito para asegurarnos de entrar al ciclo en la primera iteracion
            else
        ...
        % Para imprimir mas decimales, simplemente cambiar el numero que viene despues del punto en el fprintf del forloop.
    ...
    % Imprimir la forma final de la funcion en color verde
    fprintf('\033[0;32mLa forma final es: f(x) = %s; raiz encontrada: x = %.10f\033[0m\n', funcion, p);
