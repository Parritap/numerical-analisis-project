...
\begin{figure}[h]
	...
	\begin{tikzpicture}[scale=1.2]
		...
		\node[above left] at (\xroot,0.2) {$r$};

		% Labels on x-axis
		\node[below] at (\xfour,-0.1) {$x_4$};
		\node[below] at (\xthree,-0.1) {$x_3$};
