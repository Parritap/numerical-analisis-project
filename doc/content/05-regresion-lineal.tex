...
Haciendo uso del script de matlab elaborado para la presente sección, que el modelo produce la curva $0.0334x + 3.1589$ como se puede observar en la figura \ref{fig:ajuste01}.
