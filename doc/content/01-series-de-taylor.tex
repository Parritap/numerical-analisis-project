...
La definición formal de una serie de Taylor nos la da \cite{Stewart2012_Una}, la cual se ve en la ecuación \ref{eq:taylor-general}.
...
Para el caso especial $a = 0$ la ecuación cambia un poco, y se le atribuye el nombre de \textbf{series de MacLaurin}
